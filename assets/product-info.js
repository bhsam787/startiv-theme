...
if (!customElements.get("size-guide")) {
  class SizeGuide extends HTMLElement {
    ...
    connectedCallback() {
      document
        .querySelector(".product__info-wrapper .size-chart")
        .addEventListener("click", this.openSizeChart.bind(this));

      this.querySelector(".sizeguide-modal__close").addEventListener(
        "click",
        this.closeSizeChart.bind(this)
      );

      this.querySelectorAll(
        ".sizeguide-modal__toggle .sizeguide-modal__toggle-text"
      ).forEach((toggle) => {
        toggle.addEventListener("click", this.toggleMeasurement.bind(this));
      });
    }

    openSizeChart() {
      this.querySelector(".sizeguide-modal").classList.remove("is-hidden");
      document.querySelector("body").classList.add("overflow-hidden");
    }

    closeSizeChart() {
      this.querySelector(".sizeguide-modal").classList.add("is-hidden");
      document.querySelector("body").classList.remove("overflow-hidden");
    }

    toggleMeasurement(event) {
      const eventTarget = event.target;
      if (eventTarget.classList.contains("--cm")) {
        this.querySelector(".sizeguide-modal").dataset.state = "cm";
      } else if (eventTarget.classList.contains("--in")) {
        this.querySelector(".sizeguide-modal").dataset.state = "in";
      }
    }
    ...
    disconnectedCallback() {
      document
        .querySelector(".product__info-wrapper .size-chart")
        .removeEventListener("click", this.openSizeChart.bind(this));

      this.querySelector(".sizeguide-modal__close").removeEventListener(
        "click",
        this.closeSizeChart.bind(this)
      );
      ...
      this.querySelectorAll(
        ...
        toggle.removeEventListener("click", this.toggleMeasurement.bind(this));
      });
    }
  }
